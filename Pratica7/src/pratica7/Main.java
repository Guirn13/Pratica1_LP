...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        do {
            menu = Integer.parseInt(JOptionPane.showInputDialog("1- adicionar | 2- remover"));
            ...
            switch (menu) {
                case 1:
                    ...
                    break;
                case 2:
                    String cod_excluir = JOptionPane.showInputDialog("Digite o ISBN");
                    Delete delete = new Delete(cod_excluir);
                    break;
                case 3:
